...
var eF = WS((Mt, Dt) => {
  ...
  var Lx = 20,
    Fx = ['top', 'right', 'bottom', 'left', 'width', 'height', 'size', 'weight'],
    ...
    Hx = (function () {
      function e() {
        ;((this.connected_ = !1),
          ...
          (this.refresh = zx(this.refresh.bind(this), Lx)))
      }
      return (
      ...
      return (
        (e.prototype.observe = function (t) {
          ...
          if (!(typeof Element > 'u' || !(Element instanceof Object))) {
            ...
            n.has(t) ||
              (n.set(t, new Kx(t)), this.controller_.addObserver(this), this.controller_.refresh())
          }
        }),
  ...
  const aC = () => ({
      ...
      getPopupClassNameFromAlign: Q.any.def(oC),
        ...
        Me(() => {
          me(
            ...
            () => {
              ...
              n.value &&
                (r.value = He(() =>
                  cC(void 0, void 0, void 0, function* () {
  ...
  var or,
    pC = { Webkit: '-webkit-', Moz: '-moz-', ms: '-ms-', O: '-o-' }
  function Ro() {
    if (or !== void 0) return or
    or = ''
    var e = document.createElement('p').style,
      t = 'Transform'
    for (var n in pC) n + t in e && (or = n)
    return or
  }
  function $_() {
  ...
  var xC = new RegExp('^('.concat(_C, ')(?!px)[a-z%]+$'), 'i'),
  ...
  typeof window < 'u' && (Hr = window.getComputedStyle ? SC : $C)
  function to(e, t) {
  ...
  function Eh(e, t, n) {
    ...
    var u = '',
      c = Tr(e)
    ;(('left' in t || 'top' in t) && ((u = vC(e) || ''), Sh(e, 'none')),
  ...
  function $h(e, t, n) {
    ...
    return r === Td
      ...
      : l
        ? r === Od
          ? u
          : u + (r === IC ? -lr(e, ['border'], o) : lr(e, ['margin'], o))
        : s + lr(e, PC.slice(r), o)
  }
  var RC = { position: 'absolute', visibility: 'hidden', display: 'block' }
  function Th() {
  ...
  function R_(e, t, n, r) {
    ...
    if (f && (s.adjustX || s.adjustY) && r) {
      ...
      ;((u.adjustX = s.adjustX && T),
        ...
        (u.adjustX || u.adjustY) && (m = DC(g, h, f, u)))
    }
    return (
  ...
  function mf(e, t, n) {
    var r = n.target || t,
      o = gf(r),
      i = !zC(r, n.overflow && n.overflow.alwaysByViewport)
    return R_(e, o, n, i)
  }
  ...
  function UC(e) {
    ...
    if (n < 0) return !1
    var r = t.length - 1
    return (n == r ? t.pop() : WC.call(t, n, 1), --this.size, !0)
  }
  function YC(e) {
    var t = this.__data__,
      n = ri(t, e)
  ...
  zt.prototype.clear = VC
  zt.prototype.delete = UC
  zt.prototype.get = YC
  zt.prototype.has = XC
  zt.prototype.set = KC
  function ZC() {
  ...
  var B_ = typeof global == 'object' && global && global.Object === Object && global,
    ...
    Lt = B_ || tE || Function('return this')(),
    kn = Lt.Symbol,
    q_ = Object.prototype,
    nE = q_.hasOwnProperty,
    rE = q_.toString,
  ...
  function Zn(e) {
    return e == null ? (e === void 0 ? uE : lE) : Dh && Dh in Object(e) ? oE(e) : sE(e)
  }
  function z_(e) {
    var t = typeof e
    return e != null && (t == 'object' || t == 'function')
  }
  var cE = '[object AsyncFunction]',
    dE = '[object Function]',
  ...
  function ME(e) {
    var t = this.__data__
    return Pr ? t[e] !== void 0 : RE.call(t, e)
  }
  var DE = '__lodash_hash_undefined__'
  function BE(e, t) {
    var n = this.__data__
    return ((this.size += this.has(e) ? 0 : 1), (n[e] = Pr && t === void 0 ? DE : t), this)
  }
  function bn(e) {
    var t = -1,
      n = e == null ? 0 : e.length
  ...
  bn.prototype.clear = $E
  bn.prototype.delete = TE
  bn.prototype.get = AE
  bn.prototype.has = ME
  bn.prototype.set = BE
  function qE() {
  ...
  function oi(e, t) {
    var n = e.__data__
    return zE(t) ? n[typeof t == 'string' ? 'string' : 'hash'] : n.map
  }
  function LE(e) {
  ...
  function VE(e, t) {
    ...
    if (n instanceof zt) {
      var r = n.__data__
      if (!Or || r.length < jE - 1) return (r.push([e, t]), (this.size = ++n.size), this)
  ...
  function WE(e) {
    return (this.__data__.set(e, GE), this)
  }
  function UE(e) {
    return this.__data__.has(e)
  }
  ...
  Mo.prototype.add = Mo.prototype.push = WE
  Mo.prototype.has = UE
  function YE(e, t) {
  ...
  function F_(e, t, n, r, o, i) {
    ...
    for (i.set(e, t), i.set(t, e); ++d < s; ) {
      ...
      if (h) {
        if (
          !YE(t, function (b, y) {
            if (!XE(h, y) && (g === b || o(g, b, n, r, i))) return h.push(y)
          })
        ) {
          f = !1
          break
  ...
  function h$(e, t, n, r, o, i, a) {
    switch (n) {
      ...
      case l$:
        var l = r & e$
        if ((s || (s = QE), e.size != t.size && !l)) return !1
        var u = a.get(e)
        if (u) return u == t
        ;((r |= t$), a.set(e, t))
  ...
  var k_ = Object.prototype,
    ...
    H_ = Fh(
      ...
      ? Fh
      : function (e) {
          return Hn(e) && x$.call(e, 'callee') && !C$.call(e, 'callee')
        }
  function E$() {
    return !1
  }
  ...
  function I$(e, t) {
    ...
    return (
      (t = t ?? O$),
      !!t && (n == 'number' || (n != 'symbol' && P$.test(e))) && e > -1 && e % 1 == 0 && e < t
    )
  }
  ...
  var N$ = '[object Arguments]',
    ...
    Te = {}
  Te[U$] = Te[Y$] = Te[X$] = Te[K$] = Te[Z$] = Te[J$] = Te[Q$] = Te[eT] = Te[tT] = !0
  Te[N$] =
    Te[R$] =
    Te[G$] =
    Te[M$] =
  ...
  function gT(e, t, n, r, o, i) {
    ...
    for (var d = l; d--; ) {
      var f = s[d]
      if (!(a ? f in t : vT.call(t, f))) return !1
    }
    var h = i.get(e),
      g = i.get(t)
  ...
  function ET(e, t, n, r, o, i) {
    ...
    if (f && !c)
      return (i || (i = new Kt()), a || yf(e) ? F_(e, t, n, r, o, i) : h$(e, t, l, n, r, o, i))
    if (!(n & xT)) {
    ...
    return f ? (i || (i = new Kt()), gT(e, t, n, r, o, i)) : !1
  }
        ...
        const o = de({}),
          ...
          [a, s] = jC(
            () => {
              ...
              if (!f && h && i.value) {
                ...
                return (
                  y && M_(y) ? (b = mf(v, y, g)) : p && (b = LC(v, p, g)),
                  HC(_, v),
                  m && b && m(v, b),
                  !0
                )
          ...
          c = () => {
            ...
            ;(i.value !== u.value.element &&
              ...
              (o.value.element !== h || !kC(o.value.point, g) || !$T(o.value.align, e.align)) &&
                (a(),
                l.value.element !== h &&
        ...
        return (
          ...
          () => {
            const u = D(D(D({}, e), n), { visible: i.value }),
              c = a.value
                ? F(uC, oe(oe({}, u), {}, { mobile: e.mobile, ref: s }), { default: r.default })
                : F(PT, oe(oe({}, u), {}, { ref: s }), { default: r.default })
  ...
  function NT(e, t, n, r) {
    ...
    for (let a = 0; a < i.length; a += 1) {
      const s = i[a]
      if (AT(e[s].points, o, r)) return `${t}-placement-${s}`
    }
    return ''
  }
  const RT = {
  ...
  const DT = `vc-util-locker-${Date.now()}`
  let rp = 0
  function BT() {
    return (
    ...
    LT = te({
      ...
      methods: {
        ...
        handleGetPopupClassFromAlign(e) {
          ...
          return (r && o && t.push(NT(o, i, e, a)), s && t.push(s(e)), t.join(' '))
        },
        getPopupAlign() {
          const e = this.$props,
        ...
        getComponent() {
          ...
          return F(IT, x, { default: this.$slots.popup || (() => QS(this, 'popup')) })
        },
        attachParent(e) {
          He.cancel(this.attachId)
  ...
  const J_ = te({
      ...
      setup(e, t) {
        ...
        const _ = (w) => {
          ...
          S = X(() => (e.style && typeof e.style != 'string' ? HT(e.style) : e.style))
        return () => {
    ...
    VT = `accept acceptcharset accesskey action allowfullscreen allowtransparency
...
summary tabindex target title type usemap value width wmode wrap`,
    GT = `onCopy onCut onPaste onCompositionend onCompositionstart onCompositionupdate onKeydown
  ...
  const wf = (e, t) => t || e,
    ...
    QT = en('Space', (e) => [JT(e), ZT(e)])
  var eO = U_(Object.getPrototypeOf, Object),
    tO = '[object Object]',
    ...
    iO = ew.call(Object)
  function aO(e) {
    if (!Hn(e) || Zn(e) != tO) return !1
    var t = eO(e)
    if (t === null) return !0
    var n = oO.call(t, 'constructor') && t.constructor
    return typeof n == 'function' && n instanceof n && ew.call(n) == iO
  }
  var sO = '[object Map]',
    lO = '[object Set]',
    uO = Object.prototype,
  ...
  function tw(e) {
    ...
    if (
      ...
      return !e.length
    var t = Pt(e)
    if (t == sO || t == lO) return !e.size
    if (W_(e)) return !Y_(e).length
    for (var n in e) if (cO.call(e, n)) return !1
    return !0
  }
  const dO = () => ({
      compactSize: String,
  ...
  const pO = (e) => ({ animationDuration: e, animationFillMode: 'both' }),
    vO = (e) => ({ animationDuration: e, animationFillMode: 'both' }),
    rw = function (e, t, n, r) {
      ...
      ${i}${e}-enter,
      ${i}${e}-appear
    `]: D(D({}, pO(r)), { animationPlayState: 'paused' }),
        [`${i}${e}-leave`]: D(D({}, vO(r)), { animationPlayState: 'paused' }),
        [`
    ...
    gO = new Ye('antFadeIn', { '0%': { opacity: 0 }, '100%': { opacity: 1 } }),
    mO = new Ye('antFadeOut', { '0%': { opacity: 1 }, '100%': { opacity: 0 } }),
    yO = function (e) {
      let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1
      const { antCls: n } = e,
        r = `${n}-fade`,
        o = t ? '&' : ''
      return [
        rw(r, gO, mO, e.motionDurationMid, t),
        {
          [`
        ${o}${r}-enter,
        ${o}${r}-appear
  ...
  function iw(e) {
    ...
    const { componentCls: n } = e,
      r = `${n}-compact`
    return { [r]: D(D({}, AO(e, r, t)), NO(n, r, t)) }
  }
  const tt = { adjustX: 1, adjustY: 1 },
    ...
    RO = { prefixCls: String, id: String, overlayInnerStyle: Q.any },
    MO = te({
      compatConfig: { MODE: 3 },
      name: 'TooltipContent',
      props: RO,
  ...
  const BO = te({
      ...
      setup(e, t) {
        ...
        return (
          ...
          () => {
            ...
            return F(LT, A, { default: n.default })
          }
        )
      },
    }),
    ...
    zO = { adjustX: 1, adjustY: 1 },
    yp = { adjustX: 0, adjustY: 0 },
    LO = [0, 0]
  function bp(e) {
    return typeof e == 'boolean' ? (e ? zO : yp) : D(D({}, yp), e)
  }
  function FO(e) {
    const {
        arrowWidth: t = 4,
    ...
    return (
      Object.keys(a).forEach((s) => {
        ;((a[s] = i
          ? D(D({}, a[s]), { overflow: bp(o), targetOffset: LO })
  ...
  const kO = No.map((e) => `${e}-inverse`),
    HO = ['success', 'processing', 'error', 'default', 'warning']
  function lw(e) {
  ...
  function WO(e, t) {
    const {
      ...
      { dropdownArrowOffsetVertical: d, dropdownArrowOffset: f } = GO({
        sizePopupArrow: r,
        contentRadius: c,
        borderRadiusOuter: a,
      }),
    ...
    return {
      [n]: {
        [`${n}-arrow`]: [
          D(D({ position: 'absolute', zIndex: 1, display: 'block' }, rC(r, i, a, l, s)), {
            '&:before': { background: l },
          }),
        ],
        [[
    ...
    YO = (e, t) =>
      en(
        ...
        (r) => {
          ...
          return [UO(l), ow(r, 'zoom-big-fast')]
        },
        (r) => {
      ...
      setup(e, t) {
        ...
        const b = X(() => {
            ...
            return (
              ...
              P || FO({ arrowPointAtCenter: R, autoAdjustOverflow: E })
            )
          }),
          y = ($) => $ || $ === '',
          p = ($) => {
            ...
            if (
              ...
              const { picked: E, omitted: z } = XO(nx($), [
                  'position',
                  'left',
                  'right',
                  'top',
  ...
  function oP(e, t) {
    ...
    return (
      ...
      Ln(F(rP, { target: e, className: t }, null), n),
      () => {
  ...
  function iP(e, t) {
    ...
    function o() {
      ...
      const a = At(n)
      ;(r?.(),
        !((!((i = t?.value) === null || i === void 0) && i.disabled) || !a) && (r = oP(a, e.value)))
    }
    return (
      je(() => {
        r?.()
  ...
  function dP(e) {
    ...
    return { [t]: D(D({}, uP(e, t)), cP(e.componentCls, t)) }
  }
  const fP = (e) => {
    ...
    gP = (e) => D(D({}, hw(e)), { borderStyle: 'dashed' }),
    mP = (e) =>
      D(
        D(
    ...
    bP = (e) => D(D({}, Md(e)), { [`&${e.componentCls}:hover`]: D({}, Md(e)) }),
    _P = (e) => {
      const { componentCls: t } = e
      return {
        [`${t}-default`]: hw(e),
    ...
    EP = en('Button', (e) => {
      ...
      return [fP(r), SP(r), wP(r), xP(r), CP(r), _P(r), lP(r), iw(e, { focus: !1 }), dP(e)]
    }),
    $P = () => ({ prefixCls: String, size: { type: String } }),
    pw = _f(),
    Dd = te({
      compatConfig: { MODE: 3 },
      name: 'AButtonGroup',
      ...
      return (
        ...
        () => {
          ...
          const k =
              j && !y.value
                ? j
                : F(sP, { existIcon: !!j, prefixCls: a.value, loading: !!y.value }, null),
    ...
    bw = (e) =>
      D(
        D(
          ...
          IP(e.colorTextPlaceholder)
        ),
        {
          '&:hover': D({}, Ef(e)),
          '&:focus, &-focused': D({}, Bd(e)),
          '&-disabled, &[disabled]': D({}, AP(e)),
          '&-borderless': {
  ...
  const LP = (e) => {
    ...
    $f = en('Input', (e) => {
      const t = zP(e)
      return [RP(t), LP(t), DP(t), BP(t), qP(t), iw(t)]
    }),
    FP = () => ({
      prefixCls: String,
    ...
    GP = en('Collapse', (e) => {
      ...
      return [kP(t), jP(t), VP(t), HP(t), IO(t)]
    })
  function Pp(e) {
    let t = e
    if (!Array.isArray(t)) {
  ...
  const UP = () => Cr() && window.document.documentElement,
    lo = (e, t, n) => {
      const r = ux(n)
      return {
        [`${e.componentCls}-${t}`]: {
      ...
      setup(e, t) {
        ...
        return () => {
          ...
          const {
            ...
            z = oI(e, ['disabled', 'loading', 'addonAfter', 'suffix'])
          let {
            enterButton: C = (T =
          ...
          let V
          const H = j.type && aO(j.type) && j.type.__ANT_BUTTON
          ...
          a = (s, l) => {
            ...
            const _ = xe(
              ...
              yr(`${s}-affix-wrapper`, wf(y, g), p),
              {
                ...
                [`${r.class}`]: !aI({ addonAfter: m, addonBefore: v }) && r.class,
              },
              b
            )
...
`,
  ...
  function dI(e) {
    ...
    const r = window.getComputedStyle(e),
      ...
      l = {
        sizingStyle: cI.map((u) => `${u}:${r.getPropertyValue(u)}`).join(';'),
        paddingSize: i,
        borderSize: a,
        boxSizing: o,
      }
  ...
  function fI(e) {
    ...
    const { paddingSize: o, borderSize: i, boxSizing: a, sizingStyle: s } = dI(e, t)
    ;(rt.setAttribute('style', `${s};${uI}`), (rt.value = e.value || e.placeholder || ''))
    let l,
      u,
      c,
      d = rt.scrollHeight
          ...
          () => {
            if (s.value)
              if (u.value === Ui) u.value = Yi
                ...
                const S = fI(s.value.input, !1, d.value, f.value)
    ...
    setup(e, t) {
      ...
      return (
        ...
        () => {
          ...
          let k = F(lI, oe(oe({}, L), {}, { value: d.value, status: e.status }), { element: V })
  ...
  const _I = { click: 'onClick', hover: 'onMouseover' },
    wI = (e) => (e ? F(Of, null, null) : F(Pf, null, null)),
    SI = te({
      compatConfig: { MODE: 3 },
      name: 'AInputPassword',
      inheritAttrs: !1,
      ...
      setup(e, t) {
        ...
        const d = (v) => {
            const { action: b, iconRender: y = n.iconRender || wI } = e,
              p = _I[b] || '',
              _ = y(a.value),
              x = {
                [p]: s,
  ...
  const EI = { width: 0, height: 0, overflow: 'hidden', outline: 'none' },
    $I = { outline: 'none' },
    TI = te({
      compatConfig: { MODE: 3 },
      name: 'DialogContent',
                ...
                P || !z
                  ? Lr(
                      F(
                        ...
                        [
                          F('div', { tabindex: 0, ref: i, style: $I }, [
                            E ? E({ originVNode: V }) : V,
                          ]),
                          F('div', { tabindex: 0, ref: a, style: EI }, null),
                        ]
                      ),
                      [[Qo, P]]
                    )
        ...
        return (
          ...
          () => {
            const {
              ...
              { style: j, class: V } = n
            return F('div', oe({ class: [`${b}-root`, T] }, YT(e, { data: !0 })), [
              F(
                OI,
                {
                  prefixCls: b,
  ...
  const AI = (e) => {
    ...
    BI = en('Modal', (e) => {
      ...
      return [NI(o), RI(o), MI(o), AI(o), e.wireframe && DI(o), ow(o, 'zoom')]
    })
  var qI = function (e, t) {
    var n = {}
    for (var r in e) Object.prototype.hasOwnProperty.call(e, r) && t.indexOf(r) < 0 && (n[r] = e[r])
  ...
  UP() && Rn(document.documentElement, 'click', zI, !0)
  const LI = () => ({
      prefixCls: String,
      visible: { type: Boolean, default: void 0 },
      open: { type: Boolean, default: void 0 },
    ...
    Ze = te({
      ...
      name: 'AModal',
      inheritAttrs: !1,
      props: tn(LI(), { width: 520, confirmLoading: !1, okType: 'primary' }),
      setup(e, t) {
  ...
  const Tw = te({
    ...
    jr = (e) => {
      ...
      function a(u) {
        ;(typeof u == 'function' ? (n = u(n)) : (n = D(D({}, n), u)), r && FC(r, n, t))
      }
      const s = (u) => {
        const c = px,
          d = c.prefixCls,
  ...
  const HI = () => ({
    ...
    jI = te({
      name: 'HookModal',
      inheritAttrs: !1,
      props: tn(HI(), { config: { width: 520, okType: 'primary' } }),
      setup(e, t) {
        let { expose: n } = t
        var r
        const o = X(() => e.open),
  ...
  function GI() {
    ...
    return [r.value, () => F(VI, { key: o, ref: e }, null)]
  }
  function Rw(e) {
    return jr(Ow(e))
  }
  ...
  var Ou, Cy
  function kN() {
    return (Cy || ((Cy = 1), (Ou = { Graph: Yf(), version: FN() })), Ou)
  }
  var Pu, Ey
  function HN() {
    if (Ey) return Pu
  ...
  function JN() {
    ...
    Fy = 1
    var e = kN()
    return ((Vu = { Graph: e.Graph, json: HN(), alg: ZN(), version: e.version }), Vu)
  }
  var Gu, ky
  function ft() {
    if (ky) return Gu
  ...
  var uM = lM()
  const u0 = bx(uM),
    cM = { idle: '未连接', connecting: '连接中', open: '已连接', closed: '已关闭', error: '异常' },
    dM = {
      idle: 'is-idle',
    ...
    hM = { class: 'manager__header' },
    pM = { class: 'manager__header-actions' },
    vM = { class: 'auth-form' },
    gM = { class: 'auth-form__item' },
    mM = te({
    ...
    yM = xn(mM, [['__scopeId', 'data-v-cd143cc8']]),
    bM = ['disabled'],
    _M = { key: 0, class: 'audio-player__loading' },
    wM = { key: 1, class: 'audio-player__icon', viewBox: '0 0 24 24', fill: 'currentColor' },
    SM = { key: 2, class: 'audio-player__icon', viewBox: '0 0 24 24', fill: 'currentColor' },
    xM = { class: 'audio-player__track' },
    CM = { class: 'audio-player__time' },
    EM = te({
    ...
    $M = xn(EM, [['__scopeId', 'data-v-da15cadd']])
  function R1(e) {
    return lf() ? (gr(e), !0) : !1
  }
  function Ci(e) {
  ...
  const BM = ['data-kind'],
    qM = { class: 'manager__message-body' },
    zM = { key: 0, class: 'manager__text' },
    LM = { style: { verticalAlign: 'middle' } },
    FM = { key: 1, class: 'manager__text is-muted' },
    kM = { key: 2, class: 'manager__media' },
    HM = ['src'],
    jM = { key: 0, class: 'manager__message-time' },
    VM = { key: 0 },
    GM = { style: { userSelect: 'text' } },
    WM = { key: 1 },
    UM = { style: { userSelect: 'text' } },
    YM = ['onClick'],
    XM = te({
      __name: 'MessageList',
      props: { messages: {} },
                                    ...
                                    h.audioStream?.stream_meta
                                      ? (ee(),
                                        ve('div', VM, [
                                          ...
                                          he('span', GM, ze(h.audioStream?.stream_meta.task_id), 1),
                                        ]))
                                      : Pe('', !0),
                                    h.textStream?.stream_meta
                                      ? (ee(),
                                        ve('div', WM, [
                                          ...
                                          he('span', UM, ze(h.textStream?.stream_meta.task_id), 1),
                                        ]))
                                      : Pe('', !0),
                                  ]),
                                  default: Ve(() => [
    ...
    KM = xn(XM, [['__scopeId', 'data-v-b656e935']]),
    ZM = te({
      name: 'SessionList',
      props: {
    ...
    JM = { class: 'manager__sessions' },
    QM = { class: 'manager__tabs-header' },
    eD = { class: 'manager__session-count' },
    tD = { key: 0, class: 'manager__empty' },
    nD = { key: 1, class: 'manager__tab-strip', role: 'tablist' },
    rD = ['onClick'],
    oD = { class: 'manager__tab-text' },
    iD = ['onClick']
    ...
    return (
      ...
      ve('header', JM, [
        he('div', QM, [
          ...
          he('div', eD, ze(e.props.sessions.length) + ' 个', 1),
        ]),
  ...
  const lD = typeof window < 'u' && typeof document < 'u',
    uD = (e) => typeof e < 'u',
    cD = Object.prototype.toString,
    dD = (e) => cD.call(e) === '[object Object]',
    fD = () => {}
  function hD(e, t) {
    function n(...r) {
  ...
  function vD(e, t, n = {}) {
    ...
    return me(e, hD(r, t), o)
  }
  function An(e, t, n = {}) {
    const { eventFilter: r, ...o } = n,
      { eventFilter: i, pause: a, resume: s, isActive: l } = pD(r)
    return { stop: vD(e, t, { ...o, eventFilter: i }), pause: a, resume: s, isActive: l }
  }
  function gD(e, t = {}) {
    if (!ei(e)) return Ox(e)
  ...
  function hd(e, t, n, r = {}) {
    ...
    const v = (p) => (s ? (typeof s == 'function' ? s(p) : bD(p)) : p),
      b = () => (uD(e[t]) ? v(e[t]) : d),
      y = (p) => {
        f ? f(p) && g(m, p) : g(m, p)
      }
  ...
  So.prototype = Ei.prototype = {
    ...
    on: function (e, t) {
      ...
      if (arguments.length < 2) {
        for (; ++i < a; ) if ((o = (e = r[i]).type) && (o = SD(n[o], e.name))) return o
        return
      }
  ...
  function ID(e) {
    typeof e == 'function' ? (e = PD(e)) : (e = k1(e))
  ...
  function MD(e) {
    return this.select(e == null ? RD : ND(typeof e == 'function' ? e : j1(e)))
  }
  var DD = Array.prototype.filter
  function BD() {
    return Array.from(this.children)
  }
  function qD(e) {
    return function () {
      return DD.call(this.children, e)
    }
  }
  function zD(e) {
    return this.selectAll(e == null ? BD : qD(typeof e == 'function' ? e : j1(e)))
  }
  function LD(e) {
  ...
  function GD(e, t) {
    ...
    for (
      ...
      var c = r[u],
        d = o[u],
        f = d.length,
        h = WD(e.call(c, c && c.__data__, u, r)),
        g = h.length,
        m = (s[u] = new Array(g)),
        v = (a[u] = new Array(g)),
        b = (l[u] = new Array(f))
  ...
  function v2(e, t, n) {
    return arguments.length > 1
      ? this.each((t == null ? f2 : typeof t == 'function' ? p2 : h2)(e, t, n ?? ''))
      : Vn(this.node(), e)
  }
  function Vn(e, t) {
  ...
  function b2(e, t) {
    return arguments.length > 1
      ? this.each((t == null ? g2 : typeof t == 'function' ? y2 : m2)(e, t))
      : this.node()[e]
  }
  function W1(e) {
  ...
  function x2(e, t) {
    ...
    return this.each((typeof t == 'function' ? S2 : t ? _2 : w2)(n, t))
  }
  function C2() {
    this.textContent = ''
  }
  ...
  function T2(e) {
    return arguments.length
      ? this.each(e == null ? C2 : (typeof e == 'function' ? $2 : E2)(e))
  ...
  function A2(e) {
    return arguments.length
      ? this.each(e == null ? O2 : (typeof e == 'function' ? I2 : P2)(e))
      : this.node().innerHTML
  }
  function N2() {
  ...
  function z2(e, t) {
    var n = typeof e == 'function' ? e : F1(e),
      r = t == null ? q2 : typeof t == 'function' ? t : Jf(t)
    return this.select(function () {
  ...
  function X2(e, t, n) {
    ...
    for (s = t ? Y2 : U2, o = 0; o < i; ++o) this.each(s(r[o], t, n))
    return this
  }
  function K1(e, t, n) {
    var r = G1(e),
  ...
  function J2(e, t) {
    return this.each((typeof t == 'function' ? Z2 : K2)(e, t))
  }
  function* Q2() {
    for (var e = this._groups, t = 0, n = e.length; t < n; ++t)
  ...
  function vt(e, t) {
    if (((e = tB(e)), t === void 0 && (t = e.currentTarget), t)) {
  ...
  var Rr = 0.7,
    ...
    wt = '\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*',
    lB = /^#([0-9a-f]{3,8})$/,
    uB = new RegExp(`^rgb\\(${qn},${qn},${qn}\\)$`),
    cB = new RegExp(`^rgb\\(${wt},${wt},${wt}\\)$`),
    dB = new RegExp(`^rgba\\(${qn},${qn},${qn},${Mr}\\)$`),
    fB = new RegExp(`^rgba\\(${wt},${wt},${wt},${Mr}\\)$`),
    hB = new RegExp(`^hsl\\(${Mr},${wt},${wt}\\)$`),
    pB = new RegExp(`^hsla\\(${Mr},${wt},${wt},${Mr}\\)$`),
    b0 = {
      aliceblue: 15792383,
  ...
  function Gd(e, t, n, r) {
    return arguments.length === 1 ? mB(e) : new We(e, t, n, r ?? 1)
  }
  function We(e, t, n, r) {
  ...
  function SB(e) {
    return (e = +e) == 1
      ? nS
      : function (t, n) {
          return n - t ? wB(t, n, e) : th(isNaN(t) ? n : t)
        }
  }
  function nS(e, t) {
    var n = t - e
    return n ? _B(e, n) : th(isNaN(e) ? t : e)
  }
  ...
  function Yd(e) {
    if (!Gn) {
      ...
      t > 24
        ...
        : (ar || ((Vo = Dr.now()), (ar = setInterval(LB, aS))), (Gn = 1), sS(P0))
    }
  }
  function I0(e, t, n) {
    var r = new Go()
  ...
  var kB = Ei('start', 'end', 'cancel', 'interrupt'),
    HB = [],
    uS = 0,
    A0 = 1,
    Xd = 2,
  ...
  function UB(e, t) {
    ...
    return this.each((t == null ? GB : WB)(n, e, t))
  }
  function oh(e, t, n) {
    var r = e._id
    return (
  ...
  function eq(e, t) {
    ...
    return this.attrTween(
      e,
      typeof t == 'function'
        ? (n.local ? QB : JB)(n, r, oh(this, 'attr.' + e, t))
        : t == null
          ? (n.local ? XB : YB)(n)
          : (n.local ? ZB : KB)(n, r, t)
    )
  ...
  function iq(e, t) {
    ...
    var r = $i(e)
    return this.tween(n, (r.local ? rq : oq)(r, t))
  }
  function aq(e, t) {
    return function () {
  ...
  function lq(e) {
    var t = this._id
    return arguments.length
      ? this.each((typeof e == 'function' ? aq : sq)(t, e))
  ...
  function dq(e) {
    var t = this._id
    return arguments.length
      ? this.each((typeof e == 'function' ? uq : cq)(t, e))
  ...
  function hq(e) {
    var t = this._id
    return arguments.length ? this.each(fq(t, e)) : pt(this.node(), t).ease
  }
  function pq(e, t) {
    return function () {
      var n = t.apply(this, arguments)
  ...
  function vq(e) {
    ...
    return this.each(pq(this._id, e))
  }
  function gq(e) {
    typeof e != 'function' && (e = H1(e))
    for (var t = this._groups, n = t.length, r = new Array(n), o = 0; o < n; ++o)
  ...
  function _q(e, t) {
    var n = this._id
    return arguments.length < 2 ? pt(this.node(), n).on.on(e) : this.each(bq(n, e, t))
  }
  function wq(e) {
    return function () {
  ...
  function Sq() {
    return this.on('end.remove', wq(this._id))
  }
  function xq(e) {
    var t = this._name,
      n = this._id
  ...
  var Eq = Xr.prototype.constructor
  function $q() {
  ...
  function Aq(e, t, n) {
    var r = (e += '') == 'transform' ? NB : cS
    return t == null
      ? this.styleTween(e, Tq(e, r)).on('end.style.' + e, dS(e))
      : typeof t == 'function'
        ? this.styleTween(e, Pq(e, r, oh(this, 'style.' + e, t))).each(Iq(this._id, e))
        : this.styleTween(e, Oq(e, r, t), n).on('end.style.' + e, null)
  }
  function Nq(e, t, n) {
    return function (r) {
  ...
  function qq(e) {
    return this.tween(
      'text',
      typeof e == 'function' ? Bq(oh(this, 'text', e)) : Dq(e == null ? '' : e + '')
    )
  }
  function zq(e) {
    return function (t) {
  ...
  var Gq = { time: null, delay: 0, duration: 250, ease: Vq }
  function Wq(e, t) {
  ...
  function Uq(e) {
    ...
    e instanceof qt
      ? ((t = e._id), (e = e._name))
      : ((t = fS()), ((n = Gq).time = nh()), (e = e == null ? null : e + ''))
    for (var r = this._groups, o = r.length, i = 0; i < o; ++i)
      for (var a = r[i], s = a.length, l, u = 0; u < s; ++u)
        (l = a[u]) && Oi(l, e, t, u, a, n || Wq(l, t))
    return new qt(r, this._parents, e, t)
  }
  Xr.prototype.interrupt = VB
  Xr.prototype.transition = Uq
  const po = (e) => () => e
  function Yq(e, { sourceEvent: t, target: n, transform: r, dispatch: o }) {
    Object.defineProperties(this, {
      type: { value: e, enumerable: !0, configurable: !0 },
      sourceEvent: { value: t, enumerable: !0, configurable: !0 },
  ...
  const tz = ['INPUT', 'SELECT', 'TEXTAREA'],
    nz = typeof document < 'u' ? document : null
  function Zd(e) {
    var t, n
    const r =
    ...
    return tz.includes(r?.nodeName) || o || !!i
  }
  function rz(e) {
...
`
  ...
  function wS(e) {
    ...
    for (let n = 0; n < e.length; n++) {
      const r = e[n]
      t = fz(t, _S({ ...r.computedPosition, ...r.dimensions }))
    }
    return hz(t)
  }
  ...
  function _z({ width: e, height: t }, n) {
    return [n[0], [n[1][0] - (e || 0), n[1][1] - (t || 0)]]
  }
  function ah(e, t, n, r, o) {
    const i = _z(e.dimensions, bz(e, n, r, o)),
      a = gS(t, i)
    return {
...
Edge: ${e}`,
  ...
  function Nz(e, t, n, r) {
    ...
    let o
    return (Jt(e) ? (o = e) : (o = { ...e, id: bS(e) }), (o = mS(o, void 0, r)), dz(o, t) ? !1 : o)
  }
  ...
  function X0(e, t, n) {
    ...
    for (let i = 0; i < e.length; ++i) {
      ...
      const s = lz(a, t(a.id), a.parentNode)
  ...
  function NS(e) {
    ...
    const L = zz(),
      ...
      J = (ye, be) => {
        ...
        if (((V = O), (R = mz(i.value, d.value, O, P)), R.length)) {
  ...
  function RS({
    ...
    function C(N) {
      ...
      if (Y && ((H && N.button === 0) || !H)) {
        let Z = function (ue) {
            ;((M = mt(ue, _e)),
              (k = Oz(qr(M, S.value, !1, [1, 1]), c.value, $.value, I)),
              O || (q(), (O = !0)))
            const ge = U0(
              ue,
              {
            ...
            ;((z = ge.handleDomNode), (P = ge.connection), (E = Iz(!!k, ge.isValid)))
            const Se = {
              ...le,
              isValid: E,
            ...
            if (
              (p($e && E ? Br({ x: $e.x, y: $e.y }, S.value) : M, ge.toHandle, Pz(!!$e, E)),
              (le = Se),
              !k && !E && !z)
            )
              return _d(be)
  ...
  function Kz(e, t, n) {
    const r = Vz(e),
      ...
      i = (M) => cz(M, e.nodes, e.edges),
      a = (M) => uz(M, e.nodes, e.edges),
      s = (M) => xS(M, e.edges),
      ...
      j = (M, O, q = !0) => {
        ...
        const W = e.edges.indexOf(I),
          ae = Rz(M, O, I, q, e.hooks.error.trigger)
        if (ae) {
          const [fe] = Sd(
            [ae],
            e.isValidConnection,
      ...
      ie = (M) => {
        ...
        for (const ae of Object.keys(O)) {
          const fe = ae,
            le = O[fe]
          ![...Xz, ...q].includes(fe) && De(le) && (e[fe] = le)
        }
        ;(Hd(() => e.d3Zoom)
          .not.toBeNull()
          .then(W),
  ...
  const Zz = ['data-id', 'data-handleid', 'data-nodeid', 'data-handlepos'],
    Jz = { name: 'Handle', compatConfig: { MODE: 3 } },
    Yn = te({
      ...Jz,
      props: {
        id: { default: null },
      ...
      setup(e, { expose: t }) {
        const n = Ex(e, ['position', 'connectable', 'connectableStart', 'connectableEnd', 'id']),
          r = Oe(() => n.type ?? 'source'),
  ...
  const tL = Mi,
    nL = ['transform'],
    rL = ['width', 'height', 'x', 'y', 'rx', 'ry'],
    oL = ['y'],
    iL = { name: 'EdgeText', compatConfig: { MODE: 3 } },
    aL = te({
      ...iL,
      props: {
        x: {},
    ...
    sL = ['id', 'd', 'marker-end', 'marker-start'],
    lL = ['d', 'stroke-width'],
    uL = { name: 'BaseEdge', inheritAttrs: !1, compatConfig: { MODE: 3 } },
    Di = te({
      ...uL,
      props: {
        id: {},
  ...
  function cL({ source: e, sourcePosition: t = pe.Bottom, target: n }) {
  ...
  function dL({
    ...
    const a = t_[t],
      ...
      c = cL({ source: l, sourcePosition: t, target: u }),
      d = c.x !== 0 ? 'x' : 'y',
      f = c[d]
    let h, g, m
    const v = { x: 0, y: 0 },
  ...
  const pL = te({
    ...
    SL = wL,
    xL = { input: tL, default: Qz, output: eL },
    CL = { default: _L, straight: vL, step: yL, smoothstep: kS, simplebezier: SL }
  function EL(e, t, n) {
    const r = X(() => (m) => t.value.get(m)),
      o = X(() => (m) => n.value.get(m)),
      i = X(() => {
        const m = { ...CL, ...e.edgeTypes },
          v = Object.keys(m)
        for (const b of e.edges) b.type && !v.includes(b.type) && (m[b.type] = b.type)
        return m
      }),
      a = X(() => {
        const m = { ...xL, ...e.nodeTypes },
          v = Object.keys(m)
  ...
  const TL = { name: 'UserSelection', compatConfig: { MODE: 3 } },
    OL = te({
      ...TL,
    ...
    PL = ['tabIndex'],
    IL = { name: 'NodesSelection', compatConfig: { MODE: 3 } },
    AL = te({
      ...IL,
      setup(e) {
        const {
  ...
  const RL = { name: 'Pane', compatConfig: { MODE: 3 } },
    ML = te({
      ...RL,
        ...
        return (B, L) => (
          ...
          ve(
            ...
            [
              ...
              K(i) && K(s)
                ? (ee(),
                  ke(OL, { key: 0, 'user-selection-rect': K(s) }, null, 8, ['user-selection-rect']))
                : Pe('', !0),
              K(u) && K(d).length ? (ee(), ke(AL, { key: 1 })) : Pe('', !0),
            ],
            34
          )
        )
    ...
    DL = { name: 'Transform', compatConfig: { MODE: 3 } },
    BL = te({
      ...DL,
      setup(e) {
    ...
    qL = { name: 'Viewport', compatConfig: { MODE: 3 } },
    zL = te({
      ...qL,
      setup(e) {
        const {
          ...
          ve(
            ...
            [
              F(
                ...
                {
                  default: Ve(() => [
                    F(BL, null, { default: Ve(() => [bt(re.$slots, 'default')]), _: 3 }),
                  ]),
                  _: 3,
                },
                8,
    ...
    FL = ['id'],
    kL = ['id'],
    HL = { name: 'A11yDescriptions', compatConfig: { MODE: 3 } },
    jL = te({
      ...HL,
      setup(e) {
  ...
  const r_ = lh,
    ...
    KL = XL,
    ZL = ['id', 'markerWidth', 'markerHeight', 'markerUnits', 'orient'],
    JL = { name: 'MarkerType', compatConfig: { MODE: 3 } },
    QL = te({
      ...JL,
      props: {
        id: {},
    ...
    e3 = { class: 'vue-flow__marker vue-flow__container', 'aria-hidden': 'true' },
    t3 = { name: 'MarkerDefinitions', compatConfig: { MODE: 3 } },
    n3 = te({
      ...t3,
      setup(e) {
    ...
    r3 = { name: 'Edges', compatConfig: { MODE: 3 } },
    o3 = te({
      ...r3,
      setup(e) {
                  ...
                  (a) => (
                    ...
                    ve(
                      'svg',
                      {
                        ...
                        style: Ct({ zIndex: K(Sz)(a, K(t), K(r)) }),
                      },
                      [F(K(YL), { id: a.id }, null, 8, ['id'])],
                      4
                    )
                  )
                ),
          ...
          me(
            ...
            ([q, I, W, ae, fe, le]) => {
              ...
              typeof W < 'u' && typeof ae < 'u'
                ? (E.computedPosition = gz({ x: W, y: ae, z: fe }, ue))
    ...
    a3 = i3
  function s3(e = { includeHiddenNodes: !1 }) {
    const { nodes: t } = Ae()
    return X(() => {
  ...
  const l3 = { class: 'vue-flow__nodes vue-flow__container' },
    u3 = { name: 'Nodes', compatConfig: { MODE: 3 } },
    c3 = te({
      ...u3,
      setup(e) {
                ...
                ? (ee(!0),
                  ve(
                    ...
                    yn(
                      ...
                      (l, u, c, d) => {
                        const f = [l.id]
                        if (d && d.key === l.id && Tx(d, f)) return d
                        const h =
                          (ee(),
                          ke(K(a3), { id: l.id, key: l.id, 'resize-observer': i.value }, null, 8, [
                            'id',
                            'resize-observer',
                          ]))
                        return ((h.memo = f), h)
  ...
  const f3 = he('div', { class: 'vue-flow__edge-labels' }, null, -1),
    h3 = { name: 'VueFlow', compatConfig: { MODE: 3 } },
    p3 = te({
      ...h3,
      props: {
        id: {},
      ...
      setup(e, { expose: t, emit: n }) {
        const r = e,
          ...
          s = hd(r, 'edges', n),
          l = Ae(r),
          u = Gz({ modelValue: i, nodes: a, edges: s }, r, l)
        return (
          Uz(n, l.hooks),
          VL(),
          d3(),
          ...
          (c, d) => (
            ...
            ve(
              ...
              [
                F(zL, null, {
                  default: Ve(() => [F(o3), f3, F(c3), bt(c.$slots, 'zoom-pane')]),
                  _: 3,
                }),
                bt(c.$slots, 'default'),
                F(jL),
  ...
  ;(Rt.Lines + '', Rt.Dots + '')
  const v3 = { [Rt.Dots]: '#81818a', [Rt.Lines]: '#eee' },
    g3 = ['id', 'x', 'y', 'width', 'height', 'patternTransform'],
    m3 = { key: 2, height: '100', width: '100' },
    y3 = ['fill'],
    b3 = ['x', 'y', 'fill'],
    _3 = { name: 'Background', compatConfig: { MODE: 3 } },
    w3 = te({
      ..._3,
      props: {
        id: {},
      ...
      setup(e) {
        const { id: t, viewport: n } = Ae(),
          ...
          i = Oe(() => e.color || e.patternColor || v3[e.variant || Rt.Dots])
        return (a, s) => (
          ee(),
          ve(
            'svg',
    ...
    S3 = { class: 'signal-viewer' },
    x3 = { class: 'signal-viewer__header' },
    C3 = { class: 'signal-viewer__title-row' },
    E3 = { class: 'signal-viewer__title' },
    $3 = { key: 0, class: 'signal-viewer__session' },
    T3 = { class: 'signal-viewer__session-id' },
    O3 = { class: 'signal-viewer__count' },
    P3 = { class: 'signal-viewer__canvas' },
    I3 = { key: 1, class: 'signal-viewer__empty' },
    A3 = te({
      __name: 'SignalViewer',
      setup(e) {
        const t = Kf(),
          ...
          ve('div', S3, [
            he('div', x3, [
              he('div', C3, [
                ...
                he('span', O3, ze(l.value.length) + ' 节点', 1),
              ]),
            ]),
            he('div', P3, [
              l.value.length > 0
                ? (ee(),
                  ke(
                    ...
                    },
                    {
                      ...
                      default: Ve(() => [
                        F(K(w3), { gap: 16, size: 1, 'pattern-color': '#e5e7eb' }),
                      ]),
                      _: 1,
                    },
                    8,
    ...
    N3 = xn(A3, [['__scopeId', 'data-v-3c7259a4']]),
    R3 = { class: 'current-config-viewer' },
    M3 = { class: 'current-config-viewer__header' },
    D3 = { key: 0, class: 'current-config-viewer__meta' },
    B3 = { key: 0, class: 'current-config-viewer__empty' },
    q3 = { class: 'current-config-viewer__summary' },
    z3 = { class: 'current-config-viewer__handler-tags' },
    L3 = { class: 'current-config-viewer__json' },
    F3 = { key: 1, class: 'current-config-viewer__empty-tip' },
    k3 = te({
        ...
        return (o, i) => (
          ...
          ve('section', R3, [
            he('div', M3, [
              ...
              K(n)?.model_root
                ? (ee(), ve('span', D3, ' model_root: ' + ze(K(n).model_root), 1))
                : Pe('', !0),
            ...
            K(n)
              ? (ee(),
                ve(
                  ...
                  { key: 1 },
                  [
                    he('div', q3, 'handler 数量：' + ze(r.value.length), 1),
                    r.value.length > 0
                      ? (ee(),
                        ke(
                          K(Dn),
                      ...
                      : (ee(), ve('div', F3, '当前配置未包含 handler_configs')),
                  ],
                  64
                ))
              : (ee(), ve('div', B3, [F(K(Rx), { description: '等待 current_config 消息...' })])),
          ])
        )
      },
    }),
    H3 = xn(k3, [['__scopeId', 'data-v-5f8a5430']]),
    j3 = { class: 'manager' },
    V3 = { key: 0, class: 'manager__error' },
    G3 = { class: 'manager__content' },
    W3 = { class: 'manager__content-left' },
    U3 = { class: 'manager__detail' },
    Y3 = { key: 0, class: 'manager__empty' },
    X3 = { class: 'manager__content-right' },
    K3 = te({
      __name: 'index',
      setup(e) {
        const t = Kf(),
          ...
          (d, f) => (
            ...
            ve('div', j3, [
              F(
                ...
                {
                  status: K(n),
                  'status-text-map': K(cM),
                  'status-class-map': K(dM),
                  onReconnect: K(l),
                },
                null,
                8,
              ...
              K(r) ? (ee(), ve('section', V3, ze(K(r)), 1)) : Pe('', !0),
              he('section', G3, [
                he('div', W3, [
                  F(
                    sD,
                  ...
                  he('main', U3, [
                    K(i)
                      ? (ee(), ke(KM, { key: 1, messages: K(a) }, null, 8, ['messages']))
                      : (ee(), ve('div', Y3, '请选择或等待会话出现')),
                  ]),
                ]),
                he('div', X3, [F(N3), F(H3)]),
              ]),
    ...
    Z3 = xn(K3, [['__scopeId', 'data-v-32e21815']]),
    J3 = te({
      __name: 'ManagerApp',
      setup(e) {
        return (t, n) => (ee(), ke(Z3))
