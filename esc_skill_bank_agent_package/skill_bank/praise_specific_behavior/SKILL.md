---
name: sage-online-praise_specific_behavior
description: SAGE-online supporter skill specialized for inferred hidden need `praise_specific_behavior` (specific praise for effort or behavior). Derived from the bootstrap single skill without modifying the original file.
skill_id: praise_specific_behavior
hidden_need: praise_specific_behavior
version: bootstrap-1.0.0
source: bootstrap/esconv_seed/skill/SKILL.md
---

# SAGE Online Skill: Specific Praise For Effort Or Behavior
...
## Hidden Need Specialization: Praise Specific Behavior

When the inferred hidden need is `praise_specific_behavior`:

- Name a specific effort, choice, or behavior the seeker already made.
- Praise the process or care shown, not just the outcome.
- Avoid generic compliments that could apply to anyone.
- Do not use praise to pivot away from unresolved hurt too quickly.
- Keep praise sincere and proportionate to what was shared.
