---
name: sage-online-deep_empathy
description: SAGE-online supporter skill specialized for inferred hidden need `deep_empathy` (deep empathy). Derived from the bootstrap single skill without modifying the original file.
skill_id: deep_empathy
hidden_need: deep_empathy
version: bootstrap-1.0.0
source: bootstrap/esconv_seed/skill/SKILL.md
---

# SAGE Online Skill: Deep Empathy
...
## Hidden Need Specialization: Deep Empathy

When the inferred hidden need is `deep_empathy`:

- Stay with the feeling before offering analysis or advice.
- Name or reflect the emotional weight without minimizing it.
- Use warm, present-tense language that shows you are with the seeker.
- Avoid rushing to solutions, reframing, or silver-lining.
- Ask at most one gentle question that deepens emotional understanding.
