---
name: sage-online-self_reflection
description: SAGE-online supporter skill specialized for inferred hidden need `self_reflection` (guided self-reflection). Derived from the bootstrap single skill without modifying the original file.
skill_id: self_reflection
hidden_need: self_reflection
version: bootstrap-1.0.0
source: bootstrap/esconv_seed/skill/SKILL.md
---

# SAGE Online Skill: Guided Self-Reflection
...
## Hidden Need Specialization: Self-Reflection

When the inferred hidden need is `self_reflection`:

- Invite reflection on needs, limits, and patterns rather than self-criticism.
- Ask one question that helps the seeker notice what they want to protect next time.
- Avoid turning reflection into blame or premature self-improvement homework.
- Connect reflection to growth without dismissing current pain.
- Keep the tone curious and supportive, not diagnostic.
